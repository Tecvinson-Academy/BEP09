...
# 0. INITIALIZATION OF DATA STORAGE AND IMPORTING USEFUL MODULES
...
def register_student():
    try:
        ...
        print(f"Registration successful! ID: {student_id}")
        ...
        # Encrypt and store the student data
        encrypted_student = encrypt_data(student)
        students.append(encrypted_student)
        print("Student data encrypted and stored successfully.")
...
# Define the function to generate student progress report
